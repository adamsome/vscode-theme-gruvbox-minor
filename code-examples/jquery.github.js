...
GithubRepo.prototype.toHTML = function () {
  ...
  return $(
    "<div class='github-box'>" +
      ...
      "<a class='repo-stars' title='Stars' data-icon='7' href='" +
      this.url +
      "/stargazers'>" +
      this.stargazers +
      '</a>' +
      "<a class='repo-forks' title='Forks' data-icon='f' href='" +
      this.url +
      "/network'>" +
      this.forks +
      '</a>' +
      "<a class='repo-issues' title='Issues' data-icon='i' href='" +
      this.url +
      "/issues'>" +
      this.open_issues +
      '</a>' +
      ...
      "<p class='repo-update'>Latest commit to <strong>master</strong> on " +
      this.pushed_at +
      '</p>' +
      "<a class='repo-download' title='Download as zip' data-icon='w' href='" +
      this.url +
      "/zipball/master'></a>" +
      '</div>' +
      '</div>'
